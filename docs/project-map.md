...
- **ノードの構成**: ノードは幅 220px・高さ 56px の 2 段構成で、上段にタイトルを最大 2 行 (超える分は省略)、下段のメタ行に PR バッジ・非表示隣接マーク・フォーカス操作 (◎) をまとめる。アイコン類がタイトルの幅を奪わないよう、タイトル行にはテキスト以外を置かない。
