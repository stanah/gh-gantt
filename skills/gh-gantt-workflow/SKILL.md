...
`.gantt-sync/workflow.md` が存在しない場合、[templates/workflow.md](templates/workflow.md) をコピーして `.gantt-sync/workflow.md` を生成する。実例は [templates/workflow.example.md](templates/workflow.example.md) を参照。
