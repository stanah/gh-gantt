...
gh-gantt list --type milestone

# 3. タスク操作（例）
gh-gantt update 6 --milestone v1.0
gh-gantt update 6 --start-date 2026-03-01 --end-date 2026-03-15
gh-gantt link 7 --blocked-by 6
gh-gantt link 6 --set-parent draft-1
